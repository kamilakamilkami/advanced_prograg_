...
type UserServiceClient interface {
	...
	AuthenticateUser(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *userServiceClient) AuthenticateUser(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
...
type UserServiceServer interface {
	...
	AuthenticateUser(context.Context, *AuthRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) AuthenticateUser(context.Context, *AuthRequest) (*UserResponse, error) {
